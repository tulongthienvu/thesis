...
%Hầu hết những hệ thống dịch máy cho đến trước những năm 1980 đều \textit{dựa trên luật (rule based)}. Những hệ thống này thường bao gồm:
%\begin{itemize}
%	\item[•] Một từ điển song ngữ
%	\item[•] Một tập các luật ngữ pháp cho từng ngôn ngữ
%\end{itemize} 
